...
ETL-платформа на Airflow — airflow/etl_pipeline_dag.py
Проверки качества данных — airflow/data_quality_checks.py
Проекты на Greenplum — sql/greenplum_partitioning.sql

BI / Дашборды

Power BI / Superset — bi/
Скриншоты, метрики, логика построения дашбордов
